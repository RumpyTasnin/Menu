...
public class ICED extends AppCompatActivity {
    ...
    TextView iced;
    int order_id=0;
    String phone,username,address,email,uid;
   ...
   /* String previousactivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_i_c_e_d);


         Intent intent=getIntent();
         order_id=intent.getIntExtra("order_id",0);
         card1=findViewById(R.id.layout_card);
         card2=findViewById(R.id.layout_card2);
        ...
        findViewById(R.id.toolbar).findViewById(R.id.cart2).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i= new Intent(ICED.this,Cart.class);
                i.putExtra("not_order_class",true);
                i.putExtra("class","ICED");
         ...
         card1.setOnClickListener(new View.OnClickListener() {
             ...
             public void onClick(View view) {
                 Intent intent1=new Intent(ICED.this,Order.class);
                 //holder.title.setTransitionName("text_transition7");
                 intent1.putExtra("food_image",R.drawable.mint);
                 intent1.putExtra("food_name","Moroccan Mint");
                 intent1.putExtra("food_description","Iced tea made with moroccan mint leaves");
                 intent1.putExtra("food_price","175");
                 intent1.putExtra("regular","Regular");
                 intent1.putExtra("large","Large");
                 intent1.putExtra("add_ons_visibility",false);
                 intent1.putExtra("radio_group_visibility",true);
                 intent1.putExtra("regular_price","175");
                 intent1.putExtra("large_price","300");
                 intent1.putExtra("activity","com.example.menu.ICED");
         ...
         card2.setOnClickListener(new View.OnClickListener() {
             ...
             public void onClick(View view) {
                 Intent intent1=new Intent(ICED.this,Order.class);
                 //holder.title.setTransitionName("text_transition7");
                 intent1.putExtra("food_image",R.drawable.lemon);
                 intent1.putExtra("food_name","Lemon Raz");
                 intent1.putExtra("food_description","Enjoy the light refreshing taste of Lemon and Raspberry in our Bariatric Health and Wellness Lemon Razzy drink");
                 intent1.putExtra("food_price","175");
                 intent1.putExtra("regular","Regular");
                 intent1.putExtra("large","Large");
                 intent1.putExtra("add_ons_visibility",false);
        ...
        iced.setTransitionName("text_transition3");
        ...
        findViewById(R.id.navigation_drawer).findViewById(R.id.home).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // home(v);
                i=new Intent(ICED.this,MainMenu.class);
                set_Intent();
            }
        });
        findViewById(R.id.navigation_drawer).findViewById(R.id.log).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(FirebaseAuth.getInstance().getCurrentUser()!=null){
                    AlertDialog.Builder builder=new AlertDialog.Builder(ICED.this);
                    ...
                    builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            if(FirebaseAuth.getInstance().getCurrentUser()!=null){
                                ...
                                log_image.setImageResource(R.drawable.ic_login);
                                log_text.setText("Login");
                                Toast.makeText(ICED.this,"logged out",Toast.LENGTH_LONG).show();
                                order.setVisibility(View.GONE);
                                profile.setVisibility(View.GONE);
                                addresses.setVisibility(View.GONE);
                                favourites.setVisibility(View.GONE);
                    ...
                    Intent intent=new Intent(ICED.this,signIn.class);
                    startActivity(intent);
                    Toast.makeText(ICED.this,"logged in",Toast.LENGTH_LONG).show();
        ...
        findViewById(R.id.navigation_drawer).findViewById(R.id.order).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                try{  i=new Intent(ICED.this,nav_orders.class);
                    set_Intent();

                }
                catch(Exception e){
                    Toast.makeText(ICED.this,e.getMessage(),Toast.LENGTH_LONG).show();
                }
            }
        });
        findViewById(R.id.navigation_drawer).findViewById(R.id.profile).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                try{ i=new Intent(ICED.this,profile.class);
                    set_Intent();}
                catch(Exception e){
                    Toast.makeText(ICED.this,e.getMessage(),Toast.LENGTH_LONG).show();
                }
        ...
        findViewById(R.id.navigation_drawer).findViewById(R.id.address).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                i=new Intent(ICED.this,Addresses.class);
                set_Intent();
            }
        });
        findViewById(R.id.navigation_drawer).findViewById(R.id.favourite).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                i=new Intent(ICED.this,Favourites.class);
                set_Intent();
            }
        });
            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        int permissionCheck = ContextCompat.checkSelfPermission(ICED.this, Manifest.permission.CALL_PHONE);
        ...
        Dialog dialog=new Dialog(ICED.this);
    ...
    private void setRecyclerView2() {
        ...
        recyclerView2=findViewById(R.id.recyclertext5);
        recyclerView2.setHasFixedSize(true);
        recyclerView2.setLayoutManager(new LinearLayoutManager(ICED.this,LinearLayoutManager.HORIZONTAL,false));
        ...
        adapter2=new Adapter2(getApplicationContext(),arrayList2,ICED.this,username,phone,email,address,uid);
    ...
    public void onBackPressed() {
        Intent intent;
        intent = new Intent(ICED.this, MainMenu.class);
