...
public class reorder_dataset {
    ...
    public reorder_dataset() {
    }

    public reorder_dataset(String extra_shot_price, String iced_price, String food_name, String food_price, String food_type,
                           String instructions, String layout, int food_amount, int extra_shot_amount, int iced_amount) {
