...
public class HOT extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_h_o_t);
        ...
        hot.setTransitionName("text_transition2");
        ...
        findViewById(R.id.navigation_drawer).findViewById(R.id.home).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // home(v);
                i=new Intent(HOT.this,MainMenu.class);
                set_Intent();
            }
        });
        findViewById(R.id.navigation_drawer).findViewById(R.id.log).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(FirebaseAuth.getInstance().getCurrentUser()!=null){
                    AlertDialog.Builder builder=new AlertDialog.Builder(HOT.this);
                    ...
                    builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            if(FirebaseAuth.getInstance().getCurrentUser()!=null){
                                ...
                                log_image.setImageResource(R.drawable.ic_login);
                                log_text.setText("Login");
                                Toast.makeText(HOT.this,"logged out",Toast.LENGTH_LONG).show();
                                order.setVisibility(View.GONE);
                                profile.setVisibility(View.GONE);
                                addresses.setVisibility(View.GONE);
                                favourites.setVisibility(View.GONE);
                    ...
                    Intent intent=new Intent(HOT.this,signIn.class);
                    startActivity(intent);
                    Toast.makeText(HOT.this,"logged in",Toast.LENGTH_LONG).show();
        ...
        findViewById(R.id.navigation_drawer).findViewById(R.id.order).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                try{  i=new Intent(HOT.this,nav_orders.class);
                    set_Intent();

                }
                catch(Exception e){
                    Toast.makeText(HOT.this,e.getMessage(),Toast.LENGTH_LONG).show();
                }
            }
        });
        findViewById(R.id.navigation_drawer).findViewById(R.id.profile).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                try{ i=new Intent(HOT.this,profile.class);
                    set_Intent();}
                catch(Exception e){
                    Toast.makeText(HOT.this,e.getMessage(),Toast.LENGTH_LONG).show();
                }
        ...
        findViewById(R.id.navigation_drawer).findViewById(R.id.address).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                i=new Intent(HOT.this,Addresses.class);
                set_Intent();
            }
        });
        findViewById(R.id.navigation_drawer).findViewById(R.id.favourite).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                i=new Intent(HOT.this,Favourites.class);
                set_Intent();
            }
        });
            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        int permissionCheck = ContextCompat.checkSelfPermission(HOT.this, Manifest.permission.CALL_PHONE);
        ...
        Dialog dialog=new Dialog(HOT.this);
        ...
        findViewById(R.id.toolbar).findViewById(R.id.cart2).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i= new Intent(HOT.this,Cart.class);
                i.putExtra("not_order_class",true);
                i.putExtra("class","HOT");
    ...
    private void setRecyclerView2() {
        ...
        recyclerView2 = findViewById(R.id.recyclertext4);
        recyclerView2.setHasFixedSize(true);
        recyclerView2.setLayoutManager(new LinearLayoutManager(HOT.this, LinearLayoutManager.HORIZONTAL, false));
        ...
        adapter2 = new Adapter2(getApplicationContext(), arrayList2, HOT.this,username,phone,email,address,uid);
    ...
    private void setRecyclerView() {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(HOT.this, LinearLayoutManager.HORIZONTAL, false));

        arrayList = new ArrayList<>();
        arrayList.add(new helperClass(R.drawable.chailatte, "CHAI LATTE", "Chai syrup with steamed milk and a small layer of foam", "235", "360", "Single", "Double",true,true,order_id));

        arrayList.add(new helperClass(R.drawable.hotchoc, "HOT CHOCOLATE", "Rich chocolate with steamed milk and a small layer of foam", "200", "320", "Single", "Double",true,true,order_id));
        arrayList.add(new helperClass(R.drawable.kids, "Kids Hot Chocolate", "Rich chocolate with steamed milk and a small layer of foam with marshmallow", "120", "", "Regular", "",true,false,order_id));


        adapter = new Adapter(getApplicationContext(), HOT.this, arrayList,phone,email,address,username,uid);
    ...
    public void onBackPressed() {
        Intent intent;
        intent = new Intent(HOT.this, MainMenu.class);
